...
import 'package:buddiesgram/pages/image_editor/modules/all_emojies.dart';
import 'package:buddiesgram/pages/image_editor/modules/bottombar_container.dart';
import 'package:buddiesgram/pages/image_editor/modules/colors_picker.dart';
import 'package:buddiesgram/pages/image_editor/modules/emoji.dart';
import 'package:buddiesgram/pages/image_editor/modules/text.dart';
import 'package:buddiesgram/pages/image_editor/modules/textview.dart';
            ...
            FlatButton(
                ...
                onPressed: () {
                  screenshotController
                    ...
                    //print("Capture Done");
                    //Scaffold.of().showSnackBar(SnackBar(content: Text('Picture is processing, Please wait')));
                    //final snackBar = SnackBar(content: Text('Image is processing, please wait:)'));
